				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">{{ $cateName }} (227,490 Results)</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
                            ...
                            @php
                                $altPath =  asset('./img/product02.png');
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="{{ !empty($path) ? Storage::url($path) : $altPath }}" alt="">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn" data-url="{{ route('addToCart', ['productID' => $product->id]) }}"><i class="fa fa-shopping-cart"></i> add to cart</button>
									</div>
								</div>
							</div>
							<!-- /product -->
