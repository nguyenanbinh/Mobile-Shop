			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
                        <div class="shop">
                            <div class="shop-img img-thumbnail fix-img">
                                <img src="{{ Storage::url($category->images->first()->path) }}" alt="">
							</div>
							<div class="shop-body">
                                <h3>{{ $category->name }}<br>Collection</h3>
								<a href="{{ route('front.cate-product-list', ['id' => $category->id]) }}" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
                    @endforeach
							...
							<div class="products-tabs">
								...
								<div id="tab12" class="tab-pane">
									<div class="products-slick" data-nav="#slick-nav-12">
										...
										<div class="product">
											<div class="product-img">
												<img class="img-thumbnail" src="{{ \Storage::url('xiaomi-poco-c40-thumb-vang-600x600.jpg') }}" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
